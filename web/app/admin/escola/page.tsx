        ...
        <main className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-5">
            {modules.map((mod) => {
              ...
              return (
                <div key={mod.id} className={`bg-[#111113] border rounded-2xl overflow-hidden ${mod.unlocked ? 'border-[#7B3FE4]/30' : 'border-[#1C1C1E]'}`}>
                  <div className="p-5">
                  ...
                  {isOpen && (
                    <div className="border-t border-[#1C1C1E]">
                      {mod.lessons.map((lesson) => (
                        <div key={lesson.id} className={`flex items-center gap-3 px-5 py-3 border-b border-[#1C1C1E] last:border-0 ${mod.unlocked ? 'hover:bg-[#18181A]/60' : 'opacity-50'}`}>
          ...
          <div className="bg-gradient-to-r from-amber-500/10 to-[#F59E0B]/5 border border-amber-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-[#71717A] mt-0.5">Adicione, edite ou remova módulos e aulas para todos os médicos da rede.</p>
              </div>
