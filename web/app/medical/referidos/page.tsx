...
export default function MedicalReferidosPage() {
  ...
  return (
    <div className="flex h-screen bg-[#0A0A0B] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <TopBar user={{ name: 'Dr. Ricardo Lima', role: 'doctor' }} title="Contatos IA" />
                            ...
                            <td className="px-4 py-4">
                              {ref.tipo_envio === 'lista' ? (
                                <span className="inline-flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded-md bg-blue-500/10 text-blue-400 border border-blue-500/20">
                                  <Users className="w-2.5 h-2.5" /> Lista
                                </span>
                              ) : (
                                <span className="inline-flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded-md bg-[#1C1C1E] text-[#52525B] border border-[#27272A]">
                                  <CreditCard className="w-2.5 h-2.5" /> Via cartão
                                </span>
                              )}
                            </td>
                            <td className="px-4 py-4">
                            ...
                            <td className="px-4 py-4">
                              {emEdicao ? (
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <button onClick={() => setEditandoId(null)} className="p-1.5 text-[#71717A] hover:text-white hover:bg-[#1C1C1E] rounded-lg transition-colors">
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <button onClick={() => iniciarEdicao(ref)} className="p-1.5 text-[#71717A] hover:text-white hover:bg-[#1C1C1E] rounded-lg transition-colors">
