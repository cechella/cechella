...
// ─── Fallback (shown while Supabase loads or if empty) ───────────────────────
...
// ─── Convert any Vimeo / YouTube URL to embed URL ────────────────────────────
...
function getEmbedUrl(url: string): string | null {
  ...
  if (vimeoMatch) {
    return `https://player.vimeo.com/video/${vimeoMatch[1]}?autoplay=0&title=0&byline=0&portrait=0&color=7B3FE4`
  }
  ...
  // Already an embed/iframe src — return as-is
...
export default function AulaPage() {
  ...
  // Build display data from Supabase or fallback
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-[#3F3F46] mt-0.5 flex items-center gap-1">
                        ...
                        {l.video_url && <span className="ml-1 text-emerald-500">●</span>}
                      </p>
                    </div>
                  </a>
                ))}
