...
const PERFIL_MEDICO_COMPACTO = `MÉDICO RESPONSÁVEL: Dr. Vinícius Cechella (CRM/SC 38765, UFSC). Fundador do Hormone Ecosystem. Formação: VIV Experience — Medicina Hormonal (20h) e Biòs Farmacêutica — Pellets e TRH (32h, docentes: Dr. André Malavasi, Dr. Dirceu Mendes, Dr. Sérgio Oehninger). REGRA: use "nosso protocolo médico" no funil — cite o nome apenas se o lead perguntar diretamente.`;

const KNOWLEDGE_COMPACTO = `CONHECIMENTO CIENTÍFICO (use SOMENTE se questionada — NUNCA espontaneamente no funil):
• WHI 2002 usou hormônios SINTÉTICOS em mulheres de 63 anos — não se aplica ao nosso protocolo bioidêntico.
• BMJ 2019 (1 milhão de mulheres): progesterona bioidêntica = risco de câncer idêntico a não-usuárias.
• ELITE Trial NEJM 2016: TRH iniciada <6 anos pós-menopausa reduz aterosclerose ("janela de oportunidade").
• CLARA Study (Menopause Journal, dez/2025, DOI 10.1097/GME.0000000000002687): pellet de estradiol 25mg — níveis séricos estáveis por 6 meses. Periódico oficial da The Menopause Society.
• GLADE Study (ISGE Roma, mar/2026): implante de Gestrinona — 0% eventos adversos graves, 96% sem alteração de voz.
• Diretrizes Grau A: The Menopause Society (EUA), IMS, EMAS (Europa), BMS (Reino Unido), SBEM e FEBRASGO (Brasil) — todas apoiam TRH individualizada com vias não-orais e progesterona bioidêntica.
• ANVISA 2024: alerta foi sobre uso SEM prescrição médica — nosso protocolo tem CRM ativo, farmácia com AFE da ANVISA, exames e acompanhamento.
OBJEÇÕES:
- "Caro" → "Além do valor, tem outra dúvida? Muitas descobriram que gastavam mais com consultas e suplementos sem resultado."
- "Medo de câncer/WHI" → "O WHI usou sintéticos. BMJ 2019 com 1 milhão de mulheres: bioidêntico não aumenta risco."
- "Médico é contra" → "O CLARA Study de 2025 e o GLADE Study de 2026 são específicos do implante. Posso enviar para segunda opinião?"
- "ANVISA proibiu" → "O alerta foi sobre uso irregular sem prescrição. Nosso protocolo é o oposto: CRM, AFE-ANVISA, exames."
- "Precisa do marido" → "Posso enviar material científico para vocês verem juntos."`;
